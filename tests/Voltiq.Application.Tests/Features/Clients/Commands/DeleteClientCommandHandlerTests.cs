...
public class DeleteClientCommandHandlerTests
{
    ...
    {
        return new DeleteClientCommandHandler(_clientRepoMock.Object, _unitOfWorkMock.Object);
    }
    ...
    public async Task Handle_WhenClientExists_ShouldDeleteAndReturnDeleted()
    {
        ...
        var result = await handler.Handle(new DeleteClientCommand(client.Id) { UserId = _userId },
    ...
    public async Task Handle_WhenClientNotFound_ShouldReturnNotFoundError()
    {
        ...
        var result = await handler.Handle(
            new DeleteClientCommand(Guid.NewGuid()) { UserId = _userId }, CancellationToken.None);
