...
public class RejectBudgetCommandHandlerTests
{
    ...
    private RejectBudgetCommandHandler CreateHandler()
    {
        return new RejectBudgetCommandHandler(
            _budgetUpdateRepoMock.Object,
            _unitOfWorkMock.Object);
    }

    [Fact]
    public async Task Handle_WithFinalizedBudget_ShouldRejectAndSave()
    {
        // Arrange
        ...
        var command = new RejectBudgetCommand(_budgetId) { UserId = _userId };
